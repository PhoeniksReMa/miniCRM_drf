...
$(function () {
  ...
  $('#language-control li').click(function (event) {
    ...
    $languageControlLinks.not('[miniCRM_DRF-language="' + language + '"]').parent().removeClass('active')
    $languageControlLinks.filter('[miniCRM_DRF-language="' + language + '"]').parent().addClass('active')

    $('#selected-language').text(language)

    var $codeBlocks = $('pre.highlight')
    $codeBlocks.not('[miniCRM_DRF-language="' + language + '"]').addClass('hide')
    $codeBlocks.filter('[miniCRM_DRF-language="' + language + '"]').removeClass('hide')
  })
  ...
  $('form.api-interaction').submit(function (event) {
    ...
    var $responseData = $form.find('.response-miniCRM_DRF')
  ...
  $('.toggle-view button').click(function () {
    ...
    var $modalResponseData = $modalContent.find('.response-miniCRM_DRF')
  ...
  // Authentication: none
  $authControl.find("[miniCRM_DRF-auth='none']").click(function (event) {
    event.preventDefault()
    window.auth = null
    $selectedAuthentication.text('none')
    $authControl.find("[miniCRM_DRF-auth]").closest('li').removeClass('active')
    $authControl.find("[miniCRM_DRF-auth='none']").closest('li').addClass('active')
  })
  ...
  $('form.authentication-token-form').submit(function (event) {
    ...
    $authControl.find("[miniCRM_DRF-auth]").closest('li').removeClass('active')
    $authControl.find("[miniCRM_DRF-auth='token']").closest('li').addClass('active')
  ...
  $('form.authentication-basic-form').submit(function (event) {
    ...
    $authControl.find("[miniCRM_DRF-auth]").closest('li').removeClass('active')
    $authControl.find("[miniCRM_DRF-auth='basic']").closest('li').addClass('active')
  ...
  $('form.authentication-session-form').submit(function (event) {
    ...
    $authControl.find("[miniCRM_DRF-auth]").closest('li').removeClass('active')
    $authControl.find("[miniCRM_DRF-auth='session']").closest('li').addClass('active')
